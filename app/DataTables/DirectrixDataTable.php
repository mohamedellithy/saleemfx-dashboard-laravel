...
class DirectrixDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function(Directrix $row){
               ...
               $data .='<a href="'.url('directrix-files/'.$row->id.'/edit').'" class="btn btn-sm btn-info action-datatable-btn">تعديل </a>';
               return $data;
            })
    ...
    {
        $ExpertsFiles = Directrix::select('*')->orderBy('created_at','desc');
