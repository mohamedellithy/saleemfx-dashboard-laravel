...
@section('content')
    <div class="row" id="app">
        <div class="col-lg-12">
            ...
            @endif
            <form method="post" action="{{ route('directrix-files.update',$experts_files->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">تعديل ملف مؤشر سليم</h3>
                    </div>
                    <div class="card-body" id="app">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">وصف ملف ملف مؤشر سليم</span>
                                    </div>
